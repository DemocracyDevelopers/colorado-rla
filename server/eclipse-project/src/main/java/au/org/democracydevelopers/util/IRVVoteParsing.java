...
import au.org.democracydevelopers.model.IRVBallotInterpretation;
...
public class IRVVoteParsing {
     ...
     */
    public static void recordInterpretations(final SubmittedAuditCVR submission) throws PersistenceException {
