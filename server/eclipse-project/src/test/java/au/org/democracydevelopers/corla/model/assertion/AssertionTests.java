...
public class AssertionTests {
  ...
  public static Object[][] sampleParameters(){
    // Parameter list: raw margin, diluted margin, difficulty, cvr discrepancy map,
    // one vote overs, one vote unders, two vote overs, two vote unders, others.
    return new Object[][]{
        // Small margin cases
        // No discrepancies
        {smallRawMargin, smallMargin, highDifficulty, Map.of(), 0, 0, 0, 0, 0},
        // one 1 vote understatement
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, -1), 0, 1, 0, 0, 0},
        // one 1 vote overstatement
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 1), 1, 0, 0, 0, 0},
        // one 2 vote understatement
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, -2), 0, 0, 0, 1, 0},
        // one 2 vote overstatement
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 2), 0, 0, 1, 0, 0},
        // one other discrepancy
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 0), 0, 0, 0, 0, 1},

        // two 1 vote understatements
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, -1, 2L, -1), 0, 2, 0, 0, 0},
        // two 1 vote overstatements
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 1, 2L, 1), 2, 0, 0, 0, 0},
        // two 2 vote understatements
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, -2, 2L, -2), 0, 0, 0, 2, 0},
        // two 2 vote overstatements
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 2, 2L, 2), 0, 0, 2, 0, 0},
        // two other discrepancies
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 0, 2L, 0), 0, 0, 0, 0, 2},

        // one 1 vote overstatement, one 1 vote understatement
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 1, 2L, -1), 1, 1, 0, 0, 0},
        // one 1 vote overstatement, one 2 vote overstatement
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 1, 2L, 2), 1, 0, 1, 0, 0},
        // one 1 vote overstatement, one 2 vote understatement
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 1, 2L, -2), 1, 0, 0, 1, 0},
        // one 1 vote overstatement, one other discrepancy
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 1, 2L, 0), 1, 0, 0, 0, 1},

        // one 2 vote overstatement, one 1 vote understatement
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 2, 2L, -1), 0, 1, 1, 0, 0},
        // one 2 vote overstatement, one 2 vote understatement
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 2, 2L, -2), 0, 0, 1, 1, 0},
        // one 2 vote overstatement, one other discrepancy
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 2, 2L, 0), 0, 0, 1, 0, 1},

        // one discrepancy of each type
        {smallRawMargin, smallMargin, highDifficulty, Map.of(1L, 1, 2L, -1, 3L,
            2, 4L, -2, 5L, 0), 1, 1, 1, 1, 1},

        // one discrepancy of each type (excluding overstatements)
        {smallRawMargin, smallMargin, highDifficulty, Map.of(2L, -1, 4L, -2,
            5L, 0), 0, 1, 0, 1, 1},

        // Large margin cases
        // No discrepancies
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(), 0, 0, 0, 0, 0},
        // one 1 vote understatement
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, -1), 0, 1, 0, 0, 0},
        // one 1 vote overstatement
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 1), 1, 0, 0, 0, 0},
        // one 2 vote understatement
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, -2), 0, 0, 0, 1, 0},
        // one 2 vote overstatement
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 2), 0, 0, 1, 0, 0},
        // one other discrepancy
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 0), 0, 0, 0, 0, 1},

        // two 1 vote understatements
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, -1, 2L, -1), 0, 2, 0, 0, 0},
        // two 1 vote overstatements
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 1, 2L, 1), 2, 0, 0, 0, 0},
        // two 2 vote understatements
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, -2, 2L, -2), 0, 0, 0, 2, 0},
        // two 2 vote overstatements
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 2, 2L, 2), 0, 0, 2, 0, 0},
        // two other discrepancies
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 0, 2L, 0), 0, 0, 0, 0, 2},

        // one 1 vote overstatement, one 1 vote understatement
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 1, 2L, -1), 1, 1, 0, 0, 0},
        // one 1 vote overstatement, one 2 vote overstatement
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 1, 2L, 2), 1, 0, 1, 0, 0},
        // one 1 vote overstatement, one 2 vote understatement
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 1, 2L, -2), 1, 0, 0, 1, 0},
        // one 1 vote overstatement, one other discrepancy
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 1, 2L, 0), 1, 0, 0, 0, 1},

        // one 2 vote overstatement, one 1 vote understatement
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 2, 2L, -1), 0, 1, 1, 0, 0},
        // one 2 vote overstatement, one 2 vote understatement
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 2, 2L, -2), 0, 0, 1, 1, 0},
        // one 2 vote overstatement, one other discrepancy
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 2, 2L, 0), 0, 0, 1, 0, 1},

        // one discrepancy of each type
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(1L, 1, 2L, -1, 3L,
            2, 4L, -2, 5L, 0), 1, 1, 1, 1, 1},

        // one discrepancy of each type (excluding overstatements)
        {largeRawMargin, largeMargin, smallDifficulty, Map.of(2L, -1, 4L, -2,
            5L, 0), 0, 1, 0, 1, 1}
    };
  }
